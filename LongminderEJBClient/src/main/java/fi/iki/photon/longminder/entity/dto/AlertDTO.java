...
/**
 * Data transfer object to transfer data to and from EJB backend to web application backend.
 * When using as a parameter to enterprise beans, caller must make sure the contents are valid.
 * 
 * 
 * 
...
public class AlertDTO implements Serializable {
	...
	/**
	 * Sets oneOff parameter using an integer value. 1 = true, anything else = false.
	 * @param autoRepeat
	 */
